package com.tenio.core.network.kcp.configuration;

import com.tenio.core.network.kcp.executor.MessageExecutorPool;
import com.tenio.core.network.kcp.executor.netty.NettyMessageExecutorPool;
...
public final class KcpConfiguration {
   ...
   * 处理kcp消息接收和发送的线程池
   **/
  private final MessageExecutorPool
      messageExecutorPool =
      new NettyMessageExecutorPool(
  ...
  public MessageExecutorPool getMessageExecutorPool() {
